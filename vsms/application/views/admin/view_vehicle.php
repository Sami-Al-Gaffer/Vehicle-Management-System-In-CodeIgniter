            ...
            <?php echo form_open_multipart('admin/vehicles/add'); ?>
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <br>
                            <input type="number" step="any" class="form-control" name="b_price" placeholder="Buying Price" >
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <br>
                            <input class="form-control" name="e_no" placeholder="Engine Number" >
                        </div>
                        <div class="col-xs-6">
                            <br>
                            <input class="form-control" name="c_no" placeholder="Chassis Number" >
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                         <input type="text"class="form-control" name="v_color" placeholder="Color">
                        </div>
                        <div class="col-xs-6">
